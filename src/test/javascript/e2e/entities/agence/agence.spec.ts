...
describe('Agence e2e test', () => {
  ...
  it('should load Agences', async () => {
    ...
    expect(await agenceComponentsPage.getTitle()).to.eq('problemeApp.agence.home.title');
  ...
  it('should load create Agence page', async () => {
    ...
    expect(await agenceUpdatePage.getPageTitle()).to.eq('problemeApp.agence.home.createOrEditLabel');
  ...
  it('should delete last Agence', async () => {
    ...
    expect(await agenceDeleteDialog.getDialogTitle()).to.eq('problemeApp.agence.delete.question');
