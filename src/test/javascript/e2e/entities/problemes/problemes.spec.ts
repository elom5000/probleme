...
describe('Problemes e2e test', () => {
  ...
  it('should load Problemes', async () => {
    ...
    expect(await problemesComponentsPage.getTitle()).to.eq('problemeApp.problemes.home.title');
  ...
  it('should load create Problemes page', async () => {
    ...
    expect(await problemesUpdatePage.getPageTitle()).to.eq('problemeApp.problemes.home.createOrEditLabel');
  ...
  it('should delete last Problemes', async () => {
    ...
    expect(await problemesDeleteDialog.getDialogTitle()).to.eq('problemeApp.problemes.delete.question');
